...
def add_cwd_segment(powerline):
    ...
    elif names[1] == 'workspace':
        if len(names) - 1 > max_depth:
            ...
            # ellipsis. So if you are at ~/workspace/b/c/d/e and max depth is 4, it will
            # show `~ . b ... d e`.
            #
            ...
            n_before = 3 if max_depth > 3 else max_depth - 1
            names = names[:1] + [DOT] + names[2:n_before] + [ELLIPSIS] + names[n_before - 1 - max_depth:]
